      ...
      <Popover className="relative">
        {({ open }) => (
          <>
            ...
            >
              <Popover.Panel className="absolute bottom-10 left-1/2 z-10 w-screen max-w-sm -translate-x-1/2 transform px-4 sm:px-0 lg:max-w-3xl">
                <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black/5">
                  <div className="relative grid gap-8 bg-emerald-700 p-7 lg:grid-cols-2">
                    <ChatBox />
                  </div>
                </div>
              </Popover.Panel>
